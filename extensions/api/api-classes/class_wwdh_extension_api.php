...
class WWDH_Extension_API
{
    ...
    {
        global $register_extension_helper_class;
        $this->version = $version;
        $this->basename = $basename;
        $this->main = $main;
         if (!get_option($this->basename . '-api-options')) {
            $register_extension_helper_class->wwdh_set_default_options();
        }
    }
    ...
    private function wwdh_get_id_rsa_activate_token($record, $extension = '')
    {
        ...
        try {
            ...
            do_action($this->basename.'/set_api_log', 'error', 'activate response data is empty!');
            exit();
        }
